...
grep -q '"target_path_provenance":"mixed_coordinate_port_atom_chain_non_claim"' \
  "$blocked_out/k26-source-dead-gap.json"
grep -q '"target_atom_path":\[1615075207963900,-9223372036854775800,1615075207964004\]' \
  "$blocked_out/k26-source-dead-gap.json"
